"""team_bodyberry_16542 URL Configuration
...
admin.site.site_header = "Team BodyBerry"
admin.site.site_title = "Team BodyBerry Admin Portal"
admin.site.index_title = "Team BodyBerry Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Team BodyBerry API",
        default_version="v1",
        description="API documentation for Team BodyBerry App",
    ),
    public=True,
